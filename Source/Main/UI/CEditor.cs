...
namespace CharacterEditor
{
	...
	internal sealed class CEditor
	{
		...
		internal static bool OnMap
		{
			get
			{
				return !CEditor.InStartingScreen && CEditor.bOnMap;
			}
			set
			{
				CEditor.bOnMap = value;
			}
		}
		...
		internal Dictionary<string, Faction> DicFactions
		{
			get
			{
				return this.Get<Dictionary<string, Faction>>(EType.Factions);
			}
		}
		...
		internal static void Initialize(Mod mod)
		{
			...
			harmony.Patch(AccessTools.Method(typeof(ShaderUtility), "GetSkinShader", null, null), new HarmonyMethod(typeof(CEditor), "GetBetterShader", null), null, null, null);
		}
		...
		public static bool GetBetterShader(ref Shader __result, bool skinColorOverriden)
		{
			bool o = CEditor.API.GetO(OptionB.USEFIXEDSHADER);
			bool result;
			if (o)
			{
		...
		private sealed class ModOptions : ModSettings
		{
			...
			private class DialogConfigurate : Window
			{
				...
				public override Vector2 InitialSize
				{
					get
					{
						return new Vector2(800f, (float)WindowTool.MaxH);
					}
				}
				...
				private Rect RectAccept
				{
					get
					{
						return new Rect(this.InitialSize.x - 140f, (float)this.frameH, 100f, 28f);
					}
				}
				...
				private Rect RectBottom
				{
					get
					{
						return new Rect((float)this.x, (float)this.frameH, (float)this.buttonWidth, 28f);
					}
				}
				...
				private Rect RectConfig
				{
					get
					{
						return new Rect((float)(this.x + this.framwW - 42), (float)this.y, 24f, 24f);
					}
				}
				...
				private Rect RectFrame
				{
					get
					{
						return new Rect((float)this.x, (float)this.y, (float)this.framwW, (float)(this.frameH - this.y - 15));
					}
				}
				...
				private Rect RectFullWidth
				{
					get
					{
						return new Rect((float)this.x, (float)this.y, this.InitialSize.x - 32f, 28f);
					}
				}
				...
				private Rect RectHalfWidth
				{
					get
					{
						return new Rect((float)this.x, (float)this.y, (float)this.framwW, 24f);
					}
				}
				...
				private Rect RectHotkey
				{
					get
					{
						return new Rect((float)(this.x + 130), (float)this.y, (float)(this.framwW - 155), 24f);
					}
				}
				...
				private Rect RectHotkeyLabel
				{
					get
					{
						return new Rect((float)this.x, (float)this.y, 130f, 24f);
					}
				}
				...
				private Rect RectImage
				{
					get
					{
						return new Rect((float)this.x, (float)this.y, 64f, 64f);
					}
				}
				...
				private Rect RectRemoveHotkey
				{
					get
					{
						return new Rect((float)(this.x + this.framwW - 24), (float)this.y, 24f, 24f);
					}
				}
				...
				private Rect RectSlider
				{
					get
					{
						return new Rect((float)(this.x + 100), (float)this.y, (float)(this.framwW - 100), 24f);
					}
				}
				...
				private Rect RectSliderLabel
				{
					get
					{
						return new Rect((float)this.x, (float)(this.y + 2), 130f, 24f);
					}
				}
				...
				private Rect RectSolid
				{
					get
					{
						return new Rect((float)(this.x + 25), (float)this.y, (float)this.framwW, 24f);
					}
				}
				...
				private void DrawHotkey(string kbdName, OptionS s, string title, string descr)
				{
					...
					SZWidgets.ButtonText(this.RectHotkey, (keyBindingDef == null) ? Label.NONE : k2.ToStringReadable(), delegate()
					{
						this.ChangeHotkey(kbdName);
					}, descr);
					SZWidgets.ButtonImage(this.RectRemoveHotkey, "UI/Buttons/Delete", delegate()
					{
						this.RemoveHotkey(kbdName, s);
					}, "");
		...
		private sealed class EditorUI : Window
		{
			...
			public int SizeH
			{
				get
				{
					return (int)(this.InitialSize.y - 36f);
				}
			}
			...
			public int SizeW0
			{
				get
				{
					return CEditor.API.GetO(OptionB.SHOWPAWNLIST) ? 100 : 0;
				}
			}
			...
			public int SizeW2
			{
				get
				{
					return CEditor.API.GetO(OptionB.SHOWTABS) ? 840 : -10;
				}
			}
			...
			public int TabX
			{
				get
				{
					return this.SizeW0 + this.SizeW1;
				}
			}
				...
				public void RecalcSkills()
				{
					...
					using (List<SkillRecord>.Enumerator enumerator = CEditor.API.Pawn.skills.skills.GetEnumerator())
					{
						while (enumerator.MoveNext())
						{
							...
							skillRecord.levelInt -= ((this.oBackAdult == null) ? 0 : this.oBackAdult.skillGains.Sum(delegate(SkillGain x)
							{
							...
							skillRecord.levelInt -= ((this.oBackChild == null) ? 0 : this.oBackChild.skillGains.Sum(delegate(SkillGain x)
							{
								if (x.skill != skillRecord.def)
								{
									return 0;
							...
							skillRecord.levelInt += ((backstory == null) ? 0 : backstory.skillGains.Sum(delegate(SkillGain x)
							{
								if (x.skill != skillRecord.def)
								{
									return 0;
							...
							skillRecord.levelInt += ((backstory2 == null) ? 0 : backstory2.skillGains.Sum(delegate(SkillGain x)
							{
								if (x.skill != skillRecord.def)
								{
									return 0;
						...
						if (CEditor.API.Pawn.skills != null)
						{
							...
							using (List<SkillRecord>.Enumerator enumerator = CEditor.API.Pawn.skills.skills.GetEnumerator())
							{
								while (enumerator.MoveNext())
								{
									...
									int num6 = (backstory == null) ? 0 : backstory.skillGains.Sum(delegate(SkillGain t)
									{
									...
									int num4 = (backstory2 == null) ? 0 : backstory2.skillGains.Sum(delegate(SkillGain t)
									{
										if (t.skill != skillRecord.def)
										{
											return 0;
				...
				private void DrawAbilities(int x, int y)
				{
					try
					{
						...
						if (flag)
						{
							...
							SZContainers.DrawElementStack<Ability>(new Rect((float)x, (float)y, 500f, 50f), abilities, this.bRemoveAbility, delegate(Ability abil)
							{
								CEditor.API.Pawn.abilities.RemoveAbility(abil.def);
				...
				private void DrawThingRow(ref float y, float width, Thing thing, DialogType type)
				{
					try
					{
						...
						if (flag3)
						{
							...
							{
								WindowTool.Open(new DialogObjects(type, null, (ThingWithComps)thing, false));
							}, "");
						}
			...
			private class BlockRecords
			{
				...
				private void DrawMiniCapsule(int x, int y)
				{
					...
					if (flag)
					{
						SZWidgets.ButtonImage((float)x, (float)y, 200f, 144f, "bcapsule", delegate()
						{
							WindowTool.Open(new DialogCapsuleUI());
						}, "", default(Color));
					}
			...
			private class BlockSocial : IPawnable
			{
				...
				private Func<InspirationDef, string> FGetInspirationLabel
				{
					get
					{
						return (InspirationDef i) => (i == null) ? Label.NONE : i.LabelCap;
					}
				}
				...
				private Func<MentalStateDef, string> FGetMentalLabel
				{
					get
					{
						return (MentalStateDef m) => (m == null) ? Label.NONE : m.LabelCap;
					}
				}
				...
				private Func<ThoughtDef, string> FGetThoughtLabel
				{
					get
					{
						return (ThoughtDef t) => (t == null) ? Label.NONE : t.GetThoughtLabel(0, null);
					}
				}
				...
				private Func<PawnRelationDef, string> FGetRelationLabel
				{
					get
					{
						return (PawnRelationDef r) => this.GetLabelSelectedPawn(r);
					}
				}
				...
				private Func<PawnRelationDef, string> FGetRelationLabel2
				{
					get
					{
						return (PawnRelationDef r) => this.GetLabelSelectedPawn2(r);
					}
				}
				...
				private Func<PawnRelationDef, string> FGetRelationLabel3
				{
					get
					{
						return (PawnRelationDef r) => this.GetLabelSelectedPawn3(r);
					}
				}
				...
				private Func<PawnRelationDef, string> FGetRelationLabel4
				{
					get
					{
						return (PawnRelationDef r) => this.GetLabelSelectedPawn4(r);
					}
				}
			...
			private class BlockPerson
			{
				...
				private Rect RectFullSolid
				{
					get
					{
						return new Rect((float)this.x, (float)this.y, (float)this.w, 24f);
					}
				}
			...
			private class BlockPawnList
			{
				...
				private List<PawnKindDef> ListOfPawnKinds
				{
					get
					{
						return CEditor.API.ListOf<PawnKindDef>(EType.PawnKindListed);
					}
				}
				...
				internal List<Pawn> ListOfPawns
				{
					get
					{
						return CEditor.API.ListOf<Pawn>(EType.Pawns);
					}
				}
				...
				private Dictionary<string, Faction> DicFactions
				{
					get
					{
						return CEditor.API.Get<Dictionary<string, Faction>>(EType.Factions);
					}
				}
				...
				private bool IsPlayerFaction
				{
					get
					{
						return CEditor.ListName == Label.COLONISTS;
					}
				}
				...
				{
					Text.Font = GameFont.Tiny;
					SZWidgets.FloatMenuOnButtonText<string>(new Rect((float)x, (float)y, (float)w, 25f), CEditor.ListName, this.DicFactions.Keys.ToList<string>(), (string s) => s, delegate(string listname)
					{
